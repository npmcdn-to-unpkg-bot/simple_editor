  ...
  angular.module('gg.editableText')
    .directive('editableText', ['EditableTextHelper', function (EditableTextHelper) {
      return {
        ...
        '<span ng-hide="isEditing || isWorking" class="original-text" tabindex="0" ng-dblclick="isEditing=true">{{placeholder ? (editingValue ? editingValue : placeholder) : editingValue}}</span>' +
